...
class Agent extends BaseController
{
    ...
    protected function LoginProcess()
    {
        ...
        else
        {
            ...
            if ($param['content_param']['agentsite']!='')
            {
                $agentsite = ($param['content_param']['agentsite']!='') ? ('?agentsite='.$param['content_param']['agentsite']) : '';
            }

            Helper::redirect($param['config']['SITE_DIR']."/agent/agent/login".$agentsite);
        }
